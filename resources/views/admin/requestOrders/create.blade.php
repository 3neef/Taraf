...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.requestOrder.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.request-orders.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('packaging_type') ? 'is-invalid' : '' }}" type="text" name="packaging_type" id="packaging_type" value="{{ old('packaging_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expected_price') ? 'is-invalid' : '' }}" type="text" name="expected_price" id="expected_price" value="{{ old('expected_price', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_country') ? 'is-invalid' : '' }}" type="text" name="product_country" id="product_country" value="{{ old('product_country', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('place_of_delivery') ? 'is-invalid' : '' }}" type="text" name="place_of_delivery" id="place_of_delivery" value="{{ old('place_of_delivery', '') }}" required>
