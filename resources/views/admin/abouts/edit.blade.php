    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.abouts.update", [$about->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="title_en">{{ trans('cruds.about.fields.title_en') }}</label>
                <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}" type="text" name="title_en" id="title_en" value="{{ old('title_en', $about->title_en) }}">
            ...
            <div class="form-group">
                <label for="title_ar">{{ trans('cruds.about.fields.title_ar') }}</label>
                <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $about->title_ar) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_ar') ? 'is-invalid' : '' }}" name="description_ar" id="description_ar">{!! old('description_ar', $about->description_ar) !!}</textarea>
            ...
            <div class="form-group">
                <label for="images">{{ trans('cruds.about.fields.images') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.about.fields.images_helper') }}</span>
            </div>
            <div class="form-group">
